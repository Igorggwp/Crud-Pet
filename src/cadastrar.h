...
int cadastrar(int *tamanho) {
    ...
    fflush(stdin);
    printf("Digite o servico que gostaria de utilizar: ");
    gets(cadastro[*tamanho].servico);
    strcat(cadastro[*tamanho].servico, "\n");

    fflush(stdin);
    printf("Digite o horario que gostaria do servico: ");
    gets(cadastro[*tamanho].horario);
    strcat(cadastro[*tamanho].horario, "\n");
